...
func (c *elasticsearchClusters) Get(name string, options meta_v1.GetOptions) (result *v1.ElasticsearchCluster, err error) {
...
func (c *elasticsearchClusters) List(opts meta_v1.ListOptions) (result *v1.ElasticsearchClusterList, err error) {
...
func (c *elasticsearchClusters) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("elasticsearchclusters").
...
func (c *elasticsearchClusters) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *elasticsearchClusters) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("elasticsearchclusters").
